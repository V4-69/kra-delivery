...
<?php
          if ($GLOBALS['cgv'][$magazin_cat_slug.'-site-link'] != '') {
?>
            <div class = "mt-1 pt-2 pb-2 px-md-5">
              <h5 class = "mb-3">
                  Сайт
              ...
              <div class="bd-highlight">
                <a href="<?php echo $GLOBALS['cgv'][$magazin_cat_slug.'-site-link'] ?>" class="contacts__row-info-phone">
                  <?php echo $GLOBALS['cgv'][$magazin_cat_slug.'-site-link'] ?>
                </a>
              </div>
            </div>
<?php
